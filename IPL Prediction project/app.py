...
# Load your data
final_df = pd.read_csv(r"C:\Users\Afrin\Downloads\IPL Prediction project\final_ipl_data1.csv")
teams_data = pd.read_csv(r"C:\Users\Afrin\Downloads\IPL Prediction project\teams_data.csv")
final_match = pd.read_csv(r"C:\Users\Afrin\Downloads\IPL Prediction project\final_match.csv")
batsmen_data = pd.read_csv(r"C:\Users\Afrin\Downloads\IPL Prediction project\batsmen_data.csv")
bowlers_data = pd.read_csv(r"C:\Users\Afrin\Downloads\IPL Prediction project\bowlers_data.csv")
...
def main():
    ...
    if page == "Home Page":
        ...
        st.image(r"C:\Users\Afrin\Downloads\ipl image", caption='IPL Image')
        ...
        best_model = load_model(r"C:\Users\Afrin\Downloads\IPL Prediction project\best_ipl_model_weights.keras")
        teams = ['----Select----',
                 'Chennai Super Kings', 'Delhi Capitals', 'Gujarat Titans', 'Kolkata Knight Riders',
                 'Mumbai Indians', 'Punjab Kings', 'Rajasthan Royals', 'Royal Challengers Bangalore',
                 'Sunrisers Hyderabad']
